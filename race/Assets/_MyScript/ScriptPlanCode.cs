public class ScriptPlanCode
{
    /*
     * * Unity Methode Event:
     * - Awake(): 
     * + Call when scene Start
     * + Use to "GetComponent<>()", "new",...
     *     
     * - Start(): 
     * + Call before first Frame start
     * + Use to "Get Imformation", maybe "Get Input Keycode" from Player
     *     
     * - LateUpdate(): 
     ...
     *     
     * - FixedUpdate(): 
     * + Call more than about fer Frame
    ...
    /*
     * * Button will be Focus after Click, make it auto Click by "Space" Keyboard
